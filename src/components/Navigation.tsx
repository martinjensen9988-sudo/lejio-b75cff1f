...
const Navigation = () => {
  ...
  const navLinkClass = "text-muted-foreground hover:text-foreground font-medium transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-primary after:transition-all hover:after:w-full";
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between">
              ...
              <>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg glass border-border/50 hover:border-primary/40 transition-colors">
          ...
          {/* Mobile menu button */}
          <button 
            className="lg:hidden text-foreground p-2.5 rounded-lg glass border-border/50 hover:border-primary/40 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center" 
